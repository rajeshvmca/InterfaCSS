...
#pragma mark - UIView
    ...
    NSSet* viewProperties = [NSSet setWithArray:@[
            ...
            peos(S(autoresizingMask), @{ @"none" : @(UIViewAutoresizingNone),
                                         ...
                                         @"right" : @(UIViewAutoresizingFlexibleRightMargin), @"flexibleRightMargin" : @(UIViewAutoresizingFlexibleRightMargin)}, autoresizingMaskBlock),
